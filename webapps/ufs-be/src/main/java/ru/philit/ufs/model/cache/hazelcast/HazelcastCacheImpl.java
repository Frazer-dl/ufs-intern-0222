...
public class HazelcastCacheImpl
  ...
  @Override
  public Operator getOperatorById(String id, ClientInfo clientInfo) {
    return requestData(
        id, client.getOperatorByIdMap(), OPERATOR_BY_ID, clientInfo
    );
  }
  ...
  public Boolean checkOverLimit(Limit limit, ClientInfo clientInfo) {
    ExternalEntityContainer<Boolean> container = requestDataFromExternal(limit,
        client.getOverLimitMap(),
